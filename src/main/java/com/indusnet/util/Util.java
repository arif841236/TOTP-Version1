...
/**
 * This util class for create otp and it have many logic and methods for create
 * otp.
 */
@Component
public class Util {
	private static final int[] DIGITSPOWER = { 1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000, 1100000000,1200000000 };

	/**
	 * This is No argument constructor which call all methods.
	 */
	private Util() {
	}
